...
//        dataHandler.initEntrySeats(for: date)
//        dataHandler.initTicketData(for: date)
//    }
//    
...
//    }
//    
//    func getInfo(on date: Date) {
//        let newSeatData = TicketSeatData(date: date)
//        if let data1 = dataHandler.availableSeatRegister[date], let data2 = dataHandler.bookedlistRegister[date] {
//        newSeatData.setAvailableList(list: data1)
//        newSeatData.setBookedList(list: data2)
//        }
//    }
//}
